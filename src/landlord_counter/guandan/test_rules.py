...
def run():
    ...
    #   ⇒ 出牌被游戏拒("牌太小") ✗ (一轮里 13 次被拒全是这个 ✓)
    R.she_zhi_ji_pai(8)

    def _c(z, h, i):
        return R.Card(zhi=z, hua=h, id=i)

    me = R.identify([_c(6, 1, 1), _c(6, 1, 2), _c(6, 2, 3), _c(11, 0, 4), _c(11, 2, 5)], 8)
    other = R.identify([_c(10, 0, 6), _c(10, 2, 7), _c(10, 3, 8), _c(7, 0, 9), _c(7, 2, 10)], 8)
    check("三带二主值=三张那组(666+JJ → 6)", me.zhu_zhi == 6, f"实际 {me.zhu_zhi}")
    check("三带二主值=三张那组(101010+77 → 10)", other.zhu_zhi == 10, f"实际 {other.zhu_zhi}")
    check("三带二: 666+JJ 压不过 101010+77(和游戏一致)", not R.can_beat(me, other))

    me2 = R.identify([_c(9, 0, 11), _c(9, 1, 12), _c(9, 2, 13), _c(14, 0, 14), _c(14, 3, 15)], 8)
    check("三带二主值不受带牌影响(999+AA → 9)", me2.zhu_zhi == 9, f"实际 {me2.zhu_zhi}")
    # ⚠ 别用 8 做对照 —— 级牌正是 8 ⇒ 888 是级牌(比 9 大 ✓), 拿它当"小的"会误判 ✓
    check("三带二: 999+AA 压得过 666+KK(点数比 9>6)",
          R.can_beat(me2, R.identify([_c(6, 0, 16), _c(6, 1, 17), _c(6, 2, 18),
                                      _c(13, 0, 19), _c(13, 3, 20)], 8)))
